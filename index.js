...
console.log(createMenuItem('cuban sandwhich', 9, 'lunch'));
console.log(createMenuItem('ham sandwhich', 11, 'lunch'));
console.log(createMenuItem('deviled egg', 11, 'breakfast'));
